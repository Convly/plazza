//
// DLLoader.hpp for DLLOADER in /home/jsx/Epitech/tek2/C++2/plazza/cpp_plazza/Srcs/Modules/
//
// Made by jsx
// Login   <jean-sebastien.herbaux@epitech.eu>
//
// Started on  Mon Apr 10 20:17:32 2017 jsx
// Last update Thu Apr 20 21:03:35 2017 jsx
//
...
class DLLoader
{
  ...
  public:
    ...
    std::vector<std::string>              getPaths() const {return (this->libs);}
    std::unordered_map<std::string, T*>   getInstances() const {return this->instances;}
...
#endif /* end of include guard: DLLOADER_HPP */
